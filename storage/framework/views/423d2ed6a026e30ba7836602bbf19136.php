...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-637756295-0', null);
...
?>
    ...
    <div class="am-header_user_menu">
        ...
        <div class="am-usermenu-dropdown <?php echo e($userRole == 'admin' || $userRole == 'sub_admin' ? 'am-dropdown_admin' : ''); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userRole == 'student'): ?>
                    <li>
                        <a href="<?php echo e(route('student.profile.personal-details')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.student_profile_settings_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.student_profile_settings_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.bookings')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.my_bookings_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.my_bookings_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.billing-detail')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.billing_detail_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.billing_detail_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('student.favourites')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.favourites_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.favourites_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('find-tutors')); ?>" >
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.find_tutors_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.find_tutors_menu')); ?>
                ...
                <?php elseif($userRole == 'tutor'): ?>
                    <li>
                        <a href="<?php echo e(route('tutor.dashboard')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.dashboard_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.dashboard_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('tutor.profile.personal-details')); ?>"><i class="am-icon-user-01"></i>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.profile_settings_menu')): ?>
                            <?php echo e(setting('_sidebar_menu.profile_settings_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('tutor.bookings.subjects')); ?>">
                            <i class="am-icon-calender-day"></i>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.manage_bookings_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.manage_bookings_menu')); ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('tutor.invoices')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.invoices_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.invoices_menu')); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userRole == 'tutor' || $userRole == 'student'): ?>
                    <li>
                        <a href="<?php echo e(route('laraguppy.messenger')); ?>">
                            <i class="am-icon-chat-03"></i>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(setting('_sidebar_menu.student_inbox_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.student_inbox_menu')); ?>

                            <?php elseif(setting('_sidebar_menu.inbox_menu')): ?>
                                <?php echo e(setting('_sidebar_menu.inbox_menu')); ?>

                            <?php else: ?>
                                <?php echo e(__('sidebar.messages')); ?>
                    ...
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($userRole == 'admin' || $userRole == 'sub_admin'): ?>
                    <li>
...
</script><?php /**PATH /home/mexy/Downloads/Vastora LMS v3.1.0/resources/views/components/frontend/user-menu.blade.php ENDPATH**/ ?>