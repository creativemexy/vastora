...
<?php endif; ?>
            ...
            <div class="am-login-right_title">
                <h2><?php echo !empty(setting('_general.login_heading')) ? setting('_general.login_heading') : __('auth.login_right_h2'); ?></h2>
                <h3><?php echo !empty(setting('_general.login_description')) ? setting('_general.login_description') : __('auth.login_right_h3'); ?></h3>
            </div>
         <?php $__env->endSlot(); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH /home/mexy/Downloads/Vastora LMS v3.1.0/resources/views/livewire/pages/auth/login.blade.php ENDPATH**/ ?>