...
<div class="master">
    <div class="box">
        <div class="header">
            <img src="<?php echo e(asset('demo-content/logo-white.svg')); ?>" height="40px" alt="">
        ...
        <ul class="step">
            ...
            <li class="step__divider"></li>
            <li class="step__item <?php echo e(isActive('LaravelInstaller::database')); ?> <?php echo e(isActive('LaravelInstaller::import')); ?>"><i class="step__icon ion-android-download"></i></li>
            <li class="step__divider"></li>
...
<?php /**PATH /home/mexy/Downloads/Vastora LMS v3.1.0/resources/views/vendor/installer/layouts/master.blade.php ENDPATH**/ ?>