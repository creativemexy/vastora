            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-two-wrap">
                        <div class="form-group-half @error('form.limit_short_answers') am-invalid @enderror">
                            ...
                            <input class="form-control"  wire:model="form.limit_short_answers" placeholder="250" type="text">
                        ...
                        <div class="form-group-half @error('form.limit_max_answers') am-invalid @enderror ">
                            ...
                            <div class="form-control_wrap">
                                <input class="form-control" wire:model="form.limit_max_answers" placeholder="1000" type="text">
                ...
                <div class="form-group am-form-btns">
                    <button 
                        ...
                        wire:target="saveQuizSetting(false)" 
                        class="am-white-btn" 
                        wire:click="saveQuizSetting(false)"> 
                        {{ __('quiz::quiz.save') }}
                    </button>
                    <button 
                        type="button" 
                        wire:loading.class="am-btn_disable" 
                        wire:target="saveQuizSetting(true)" 
                        class="am-btn" 
                        wire:click.prevent="saveQuizSetting(true)">
                        {{ __('quiz::quiz.update_and_continue') }}
                    </button>
                </div>
            </fieldset>
        </form>
