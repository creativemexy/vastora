<div class="am-createquiz" wire:init="loadData">
    ...
    <div class="am-createques">
                                ...
                                <div class="am-createques_collapse accordion-collapse collapse" id="am-content-question-{{ $question->id }}" aria-labelledby="am-content-question-{{ $question->id }}" 
                                    ...
                                    <div class="am-createques_list_wrap">
                                        @if(!empty($question?->description))
                                            <p class="am-quiz-discription">{!! $question?->description !!}</p>
                                        @endif
                                        @if(in_array($question?->type, [Modules\Quiz\Models\Question::TYPE_MCQ, Modules\Quiz\Models\Question::TYPE_TRUE_FALSE, Modules\Quiz\Models\Question::TYPE_FILL_IN_BLANKS]) && $question?->options->count() > 0)
        ...
        <div class="modal fade am-createques-modal" id="am-createques-modal" wire:ignore.self>
        ...
        <div class="modal fade am-successfully-popup" id="course_completed_popup" wire:ignore.self>
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
