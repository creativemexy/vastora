                            ...
                            <div class="am-quizlist_item">
                                <figure>
                                    ...
                                    @if($quizAttempt->result != Modules\Quiz\Models\QuizAttempt::RESULT_ASSIGNED)
                                        @php
                                            $statusClass = match ($quizAttempt->result) {
                                                'in_review' => 'am-quizstatus_in_review',
                                                'pass' => 'am-quizstatus_pass',
                                                default => 'am-quizstatus_fail',
                                            };
                                        @endphp
                                        <figcaption>
                                            <span class="am-quizstatus {{ $statusClass }}">{{ __('quiz::quiz.'.$quizAttempt->result)}}</span>
                                        </figcaption>
                                    @endif
                                </figure>
