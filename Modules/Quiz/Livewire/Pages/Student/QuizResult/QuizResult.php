...
class QuizResult extends Component
{
    ...
    public function mount(int $attemptId = null)
    {
        ...
        if (empty($attemptQuiz) || ($role == 'student' && $attemptQuiz->student_id != $this->user->id)) {
            abort(404);
        }
    ...
    public function render()
    {
        ...
        return view('quiz::livewire.student.quiz-result.quiz-result', compact('attemptQuiz', 'duration', 'passingGrade', 'completedAt'));
    }
}
