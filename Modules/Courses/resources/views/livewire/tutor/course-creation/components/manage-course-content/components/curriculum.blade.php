                    ...
                    <div class="cr-curriculum-content">
                        ...
                        @elseif( in_array($activeCurriculumItem['type'], ['video', 'yt_link', 'vm_link']) )
                            <div class="am-upload-options">
                                ...
                                <div class="am-radio">
                                    <input type="radio" id="video" name="media_type" value="video" wire:model.live="activeCurriculumItem.type" />
                                    <label for="video">{{ __('courses::courses.video') }}</label>
                                </div>
                                <div class="am-radio">
                                    <input type="radio" id="yt_link" name="media_type" value="yt_link" wire:model.live="activeCurriculumItem.type" />
                                    <label for="yt_link">{{ __('courses::courses.youtube_link') }}</label>
                                </div>
                                <div class="am-radio">
                                    <input type="radio" id="vimeo-link" name="media_type" value="vm_link" wire:model.live="activeCurriculumItem.type" />
                                    <label for="vimeo-link">{{ __('courses::courses.vimeo_link') }}</label>
                                </div>
                            </div>
