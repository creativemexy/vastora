...
class Categories extends Component
{
    ...
    {
        $categories_tree = Category::whereNull('parent_id')->whereNull('deleted_at')->tree()->get()->toTree()->toArray();
    ...
    private function resetInputfields()
    {
        ...
        $categories_tree = Category::whereNull('parent_id')->tree()->get()->toTree()->toArray();
        $categories_tree = hierarchyTree($categories_tree);
        $this->dispatch('initDropDown', categories_tree: $categories_tree, parentId: $this->parentId);;
    }
